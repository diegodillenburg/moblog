var _MlogModule=(()=>{var d=Object.defineProperty;var C=Object.getOwnPropertyDescriptor;var S=Object.getOwnPropertyNames;var z=Object.prototype.hasOwnProperty;var j=(s,t,e)=>t in s?d(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var T=(s,t)=>{for(var e in t)d(s,e,{get:t[e],enumerable:!0})},$=(s,t,e,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of S(t))!z.call(s,i)&&i!==e&&d(s,i,{get:()=>t[i],enumerable:!(o=C(t,i))||o.enumerable});return s};var I=s=>$(d({},"__esModule",{value:!0}),s);var E=(s,t,e)=>(j(s,typeof t!="symbol"?t+"":t,e),e);var M={};T(M,{Mlog:()=>h,default:()=>H});var p=class{constructor(t){this.onLog=t,this.originals={},this.installed=!1}install(){if(this.installed)return;["log","info","warn","error","debug"].forEach(e=>{this.originals[e]=console[e],console[e]=(...o)=>{this.originals[e].apply(console,o);let i=o.map(l=>{if(l===null)return"null";if(l===void 0)return"undefined";if(typeof l=="object")try{return JSON.stringify(l,null,2)}catch(r){return String(l)}return String(l)}).join(" ");this.onLog({type:e==="log"?"log":e,message:i,timestamp:Date.now()})}}),this.installed=!0}uninstall(){this.installed&&(Object.keys(this.originals).forEach(t=>{console[t]=this.originals[t]}),this.originals={},this.installed=!1)}};var u=class{constructor(t){this.onError=t,this.installed=!1,this.boundErrorHandler=this.handleError.bind(this),this.boundRejectionHandler=this.handleRejection.bind(this)}install(){this.installed||(window.addEventListener("error",this.boundErrorHandler),window.addEventListener("unhandledrejection",this.boundRejectionHandler),this.installed=!0)}uninstall(){this.installed&&(window.removeEventListener("error",this.boundErrorHandler),window.removeEventListener("unhandledrejection",this.boundRejectionHandler),this.installed=!1)}handleError(t){let{message:e,filename:o,lineno:i,colno:l,error:r}=t,n="";r&&r.stack?n=this.formatStack(r.stack):o&&(n=`  at ${o}:${i}:${l}`),this.onError({type:"error",message:e||"Unknown error",stack:n,timestamp:Date.now()})}handleRejection(t){let e=t.reason,o="Unhandled Promise Rejection",i="";if(e)if(e instanceof Error)o=e.message||o,i=e.stack?this.formatStack(e.stack):"";else if(typeof e=="string")o=e;else try{o=JSON.stringify(e)}catch(l){o=String(e)}this.onError({type:"error",message:`[Promise] ${o}`,stack:i,timestamp:Date.now()})}formatStack(t){return t.split(`
